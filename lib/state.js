...
import { applyReadback, applyVerificationEvidence, artifactRevisionSnapshot, createVerificationDebtForArtifact, createDependentVerificationDebts, setArtifactDependencies, createWorkspaceMutationDebt, openAcceptance, openVerificationDebts, pruneVerificationDebts, satisfyAcceptance, updateAcceptanceAfterMutation, updateAcceptanceAfterObservation, waiveAcceptance, } from './debt.js';
...
function semanticVerificationState(contract, route, mode = 'off') {
    ...
    return { required, status: required ? 'pending' : 'not-required', attempts: 0, contradictions: [], nextEvidence: [] };
}
